...
def test_execute_passes_role_appropriate_ttl_to_provider(clean_registry):
    # "deepseek-r1-distill-qwen-32b" is large enough to get the
    # short specialist TTL (I-05).
    model = FAKE_MODELS[2]
